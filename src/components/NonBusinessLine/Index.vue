<template>
  <div class="index">
    ...
    <van-nav-bar title="非营业线施工日计划列表"  right-text="关闭"  @click-right="onClickRight" fixed></van-nav-bar>
...
//            console.log("追加数据之前：" +JSON.stringify(vm.listdata));
      ...
      goSearchPage(date,slectProjectId,selectProjectName){
        this.$router.push({path: '/NonBusinessLine/NonBusinessLineSearch',query:{date:date.join('-'),slectProjectId:slectProjectId,slectProjectName:selectProjectName}});
      },

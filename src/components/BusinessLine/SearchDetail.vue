      ...
      methods: {
        loadMore(index){
          ...
          if(this.count>this.DayPlanDetail.length&&index===this.showmum){
            var url='http://whjjgc.r93535.com/DayPlanDetailSearchServlet?xmmc='+this.xmmc+'&sgksrq='+this.currenttime+'&dj='+this.dj+'&xingbie='+this.xingbie+'&sglx='+this.sglx+'&page='+this.page+'&sglc='+this.sglc+'&baseuserid='+this.baseuserid+'&kssjd=&sgjsrq='+this.currenttime
            axios.get(url)
              .then(response => {
        ...
        getDayPlanCount(data) {
          ...
          var url='http://whjjgc.r93535.com/DayPlanCountServlet?baseuserid='+this.baseuserid+'&xmmc='+this.xmmc+'&type=1&sgksrq='+this.sgksrq+'&sgjsrq='+this.sgjsrq+
        ...
        getDayPlanDetail(data,index,flag) {
          if(this.hasopen==false&&flag==true){
            ...
            var url='http://whjjgc.r93535.com/DayPlanDetailSearchServlet?xmmc='
              ...
              '&sglc='+this.sglc+'&baseuserid='+this.baseuserid+'&kssjd=&sgjsrq='+data
            axios.get(url)
              .then(response => {
